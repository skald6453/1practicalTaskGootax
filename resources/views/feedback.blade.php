            ...
            <div class="card-header">Feedback</div>
                ...
                <div class="card-body">
                    ...
                    <div class="col">
                        ...
                        <input class="form-control w-50 @error('email') is-invalid @enderror"  name="email" style="margin-left: 25%;">
                        ...
                        <div class="col">
                            ...
                            <textarea class="form-control @error('feedback') is-invalid @enderror" name="feedback" placeholder="Введите текст..."></textarea>
